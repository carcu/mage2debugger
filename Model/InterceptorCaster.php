...
class InterceptorCaster
{
    ...
    public static function castInterceptor($c, array $a, Stub $stub, $isNested)
    {
        die('ffffff');

        return self::castReflectionIntercetor($c, $a, $stub, $isNested);
    }
    ...
    public static function castReflectionInterceptor($c, array $a, Stub $stub, $isNested)
    {
        $prefix = Caster::PREFIX_VIRTUAL;

        if ($c->getThis()) {
            $a[$prefix.'this'] = new CutStub($c);
        }
