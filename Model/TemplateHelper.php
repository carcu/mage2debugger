...
class TemplateHelper
{
    ...
    private function getDumper()
    {
        if (!$this->htmlDumper && class_exists('Symfony\Component\VarDumper\Cloner\VarCloner')) {
            $this->htmlDumperOutput = new \Whoops\Util\HtmlDumperOutput();
            ...
            /*$this->htmlDumper->setDisplayOptions(
                array(
                    'maxDepth' => 2,
                    'maxStringLength' => 240,
                    'fileLinkFormat' => null,
    ...
    public function dump($value)
    {
        ...
        if ($dumper) {
            ...
            //$this->getCloner()->addCasters(
            //    array('Interceptor' => 'SalesIgniter\Debugger\Model\InterceptorCaster::castInterceptor')
            // );
            //echo \SalesIgniter\Debugger\Helper\Data::printRLevel($value, 2);
